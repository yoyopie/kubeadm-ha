...
kubectl apply -f https://raw.githubusercontent.com/yoyopie/kubeadm-ha/master/calico/rbac.yaml
curl -fsSL https://raw.githubusercontent.com/yoyopie/kubeadm-ha/master/calico/calico.yaml | sed "s!8.8.8.8!${CP0_IP}!g" | sed "s!10.244.0.0/16!${CIDR}!g" | kubectl apply -f -
...
kubectl apply -f https://raw.githubusercontent.com/yoyopie/kubeadm-ha/master/plugin/traefik.yaml
kubectl apply -f https://raw.githubusercontent.com/yoyopie/kubeadm-ha/master/plugin/metrics.yaml
kubectl apply -f https://raw.githubusercontent.com/yoyopie/kubeadm-ha/master/plugin/kubernetes-dashboard.yaml
